    ...
    <div className="max-w-[1200px] mx-auto">
      ...
      <div className="bg-white border border-gray-100 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: 'View all contact messages', href: '/control/submissions/contact' },
            { label: 'Review prayer requests', href: '/control/submissions/prayers' },
            { label: 'Manage food bank orders', href: '/control/submissions/food-bank' },
          ].map((item) => (
            <Link
              key={item.href}
              href={item.href}
